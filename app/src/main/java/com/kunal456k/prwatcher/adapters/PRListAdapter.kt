...
@ActivityScope
class PRListAdapter @Inject constructor() : ListAdapter<PullRequest, PRItemHolder>(DIFF_CALLBACK) {
    ...
    fun update(pullRequests : List<PullRequest>){
        submitList(pullRequests)
    }
}
